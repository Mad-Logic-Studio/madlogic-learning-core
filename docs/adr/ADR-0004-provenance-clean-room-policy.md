# ADR-0004: Open-source provenance and clean-room implementation policy
...
Study upstream architecture and UX under documented clean-room rules. Copy no source in this phase. Require file-level provenance and license review before any future reuse.
