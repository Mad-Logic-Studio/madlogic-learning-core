# ADR-0001: Public reusable core and private production consumers
...
Maintain reusable contracts and security architecture in a public repository while production branding, curriculum, data, destinations, credentials, and operational mappings remain in private consumer repositories.
